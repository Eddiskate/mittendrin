...
/**
 * BpcmsYtMoviesI18n form base class.
 *
 * @method BpcmsYtMoviesI18n getObject() Returns the current form's model object
 *
 * @package    blackcms
 * @subpackage form
 ...
 */
abstract class BaseBpcmsYtMoviesI18nForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'bpcms_yt_movies_idbpcms_yt_movies' => new sfValidatorChoice(array('choices' => array($this->getObject()->get('bpcms_yt_movies_idbpcms_yt_movies')), 'empty_value' => $this->getObject()->get('bpcms_yt_movies_idbpcms_yt_movies'), 'required' => false)),
