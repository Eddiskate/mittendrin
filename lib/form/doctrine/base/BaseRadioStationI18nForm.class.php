...
/**
 * RadioStationI18n form base class.
 *
 * @method RadioStationI18n getObject() Returns the current form's model object
 *
 * @package    blackcms
 * @subpackage form
 ...
 */
abstract class BaseRadioStationI18nForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'radio_station_idradio_station' => new sfValidatorChoice(array('choices' => array($this->getObject()->get('radio_station_idradio_station')), 'empty_value' => $this->getObject()->get('radio_station_idradio_station'), 'required' => false)),
