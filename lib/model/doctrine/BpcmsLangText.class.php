 ...
 */
class BpcmsLangText extends BaseBpcmsLangText {

    public function getLangTextValue() {
        $bpcms_text_i18n = Doctrine_Core::getTable('BpcmsTextI18n')->createQuery('a')
                ->where('a.bpcms_lang_text_text_name = ?', parent::getTextName())
