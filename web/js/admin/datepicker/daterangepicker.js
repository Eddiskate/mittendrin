...
!function ($) {
    ...
    DateRangePicker.prototype = {
        ...
        updateFromControl: function () {
            ...
            var dateString = dateString.replace(this.pred,'');
        ...
        updateInputText: function() {
            if (this.element.is('input'))
                this.element.val(this.pref + this.startDate.format(this.format) + this.separator + this.endDate.format(this.format));
        },
