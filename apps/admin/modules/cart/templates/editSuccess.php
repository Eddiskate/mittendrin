...
<div class="tab-content">
    ...
    <?php foreach ($lang_installs as $lang_install): ?>
        <div class="tab-pane" id="<?php echo $lang_install->getSignature() ?>"><?php include_partial('bpcmsCartI18n/form', array('form_lang' => $lang_install->getObjectType('BpcmsCartI18n', 'cart_idcart', $sf_params->get('idcart')), 'signature' => $lang_install->getSignature())) ?></div>
    <?php endforeach; ?>
</div>
